...
import { DeleteRange, GetAllFamilyMember } from "~/components/data";
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const response = await GetAllFamilyMember(token);
  const data = response.result;
  return { data, token };
};

const FamilyMemberDataTable = () => {
  ...
  return (
    <div className="w-full">
      <div className="flex justify-between items-center">
        ...
        <Button>
          <Link
            to={`/dashboard/family-member/create-family/`}
...
export default FamilyMemberDataTable;
